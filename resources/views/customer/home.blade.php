...
@section('content')
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    ...
                    <h1 class="mb-5 display-3 text-primary">Fresh Fruits, Fresh Starts!</h1>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill {{ request('kategori_id') ? '' : 'active' }}" href="{{ url('customer/home') }}">
                                    <span class="text-dark" style="width: 130px;">All Products</span>
                                </a>
                            </li>
                            @foreach($kategoris as $kategori)
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill {{ request('kategori_id') == $kategori->id ? 'active' : '' }}" href="{{ url('customer/home?kategori_id=' . $kategori->id) }}">
                                        <span class="text-dark" style="width: 130px;">{{ $kategori->nama_kategori }}</span>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                                ...
                                @if($produk->stok_produk > 0)
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item h-100">
                                            ...
                                            <div class="p-5 border border-secondary border-top-0 rounded-bottom text-center d-flex flex-column justify-content-between">
                                                <div>
                                                    <h4>{{ $produk->nama_produk }}</h4>
                                                    <div class="d-flex justify-content-center flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">Rp{{ number_format($produk->harga_produk) }} / {{ $produk->satuan }}</p>
                                                    </div>
                                                    <p class="text-muted mb-2">Stock: {{ $produk->stok_produk }} {{ $produk->satuan }}</p>
                                                </div>
                                                <div>
                                                    @if(Auth::check())
    ...
    @if(session('error'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                document.getElementById('notificationMessage').innerText = "{{ session('error') }}";
                var notificationModal = new bootstrap.Modal(document.getElementById('notificationModal'));
                notificationModal.show();
            });
        </script>
