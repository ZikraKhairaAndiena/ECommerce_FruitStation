...
<div class="container-fluid py-5">
    <div class="container py-5">
        ...
        <div class="mt-5">
            ...
            <button class="btn border-secondary rounded-pill px-4 py-3 text-primary btn-apply-coupon" type="button">Apply Coupon</button>
        </div>
...
document.querySelector('.btn-apply-coupon').addEventListener('click', function () {
    ...
    .then(data => {
        if (data.success) {
            // Perbarui tampilan diskon dan subtotal
            document.getElementById('discount-display').innerText = 'Rp ' + data.discount.toLocaleString('id-ID');
            document.getElementById('subtotal-display').innerText = 'Rp ' + data.subtotal_after_discount.toLocaleString('id-ID');
